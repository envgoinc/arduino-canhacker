...
CanHacker::CanHacker(Stream *stream, Stream *debugStream, const int INT_PIN, uint8_t cs, const uint32_t spi_clock) {
    _stream = stream;
...
CanHacker::ERROR CanHacker::readFrame(struct can_frame &frame){
